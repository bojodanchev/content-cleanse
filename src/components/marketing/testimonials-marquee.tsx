...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="w-[380px] shrink-0 rounded-xl border border-border/50 bg-card/60 backdrop-blur-sm p-6">
...
function MarqueeRow({
  ...
  const animationClass =
    direction === 'left' ? 'animate-[marquee-left_40s_linear_infinite]' : 'animate-[marquee-right_40s_linear_infinite]'
